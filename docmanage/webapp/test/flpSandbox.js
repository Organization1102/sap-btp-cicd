		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#kupitflexiblewfdocmanage-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"kupitflexiblewfdocmanage-display": {
								"semanticObject": "kupitflexiblewfdocmanage",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=kupit.flexiblewf.docmanage",
									"url": sap.ui.require.toUrl("kupit/flexiblewf/docmanage")
								}
							}
						}
					}
